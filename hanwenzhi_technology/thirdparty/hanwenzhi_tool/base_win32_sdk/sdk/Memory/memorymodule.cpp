...
#define GET_HEADER_DICTIONARY(module, idx)	&(module)->headers->OptionalHeader.DataDirectory[idx]
	...
	HMEMORYMODULE CMemoryUtil::MemoryLoadLibrary(const void *data)
	{
...
error:
	...
	FARPROC CMemoryUtil::MemoryGetProcAddress(HMEMORYMODULE module, const char *name)
	{
	...
	void CMemoryUtil::MemoryFreeLibrary(HMEMORYMODULE mod)
	{
		int i;
